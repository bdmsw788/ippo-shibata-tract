...
export const RAW_DISTRICTS: RawDistrict[] = [
 {id:'honcho', name:'本庁地区', short:'本庁', areas:[
   ...
   // 以下、市の統計では世帯数非公開(秘匿)または人口データなしのため世帯数は推定値
   ['中田町3丁目',1],['新栄町3丁目',1],['富塚(字)',1],['東塚ノ目',0],['中田(字)',0],['小舟渡',0],
 ]},
...
// 市公表の総世帯数は38,025。世帯数が秘匿(非公開)の8地域に推定1世帯を割り当てているため、
// 全エリアの世帯数を合計した値(このアプリの進捗計算に使う分母)は38,033になる。
export const TOTAL_HOUSEHOLDS = 38033;
