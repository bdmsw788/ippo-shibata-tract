...
export const RAW_DISTRICTS: RawDistrict[] = [
 ...
 {id:'toyoura', name:'豊浦地区', short:'豊浦', areas:[
   ...
   // 大沢は令和2年国勢調査の生データで「下飯塚 大沢」の合算1行(185人/68世帯)としてのみ
   // 記録されているが、国勢調査GISの独立集計(toukei-labo.com)では下飯塚単独で185人/68世帯
   // と、合算値と完全一致する数値が出ている。つまり大沢の実質的な寄与分は0と判断できる
 ...
 {id:'shiundera', name:'紫雲寺地区', short:'紫雲寺', areas:[
   ...
   // 元郷は令和2年国勢調査の生データでは「元郷 人橋」の合算1行(100人/31世帯)だが、
   // 国勢調査GISの独立集計では元郷単独0人/0世帯・人橋単独104人/32世帯となっており、
   // 元郷の実質的な寄与分は0と判断できる。真野代も同様に「真野原外 真野代」の合算1行
   // (919人/282世帯)だが、独立集計では真野原外単独で957人/295世帯(合算値を上回る)と
   // 出ており、真野代の寄与分もほぼ0とみられる
   ['元郷',0],['真野代',0],
 ]},
];
